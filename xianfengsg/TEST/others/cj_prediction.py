...
def insertdb(db,data):
    ...
    sql = """INSERT INTO dm_cj_forecast (belonged_date,cnt_at,custom_business_num,custom_stock_num,custom_terminal_num,forecast_qty,manufacturer_num,piece_bar_code) VALUES (str_to_date(%s,'%%Y-%%m-%%d'), str_to_date(%s,'%%Y-%%m-%%d'),'%s','%s','%s','%s',%s,%s)"""
    try:
