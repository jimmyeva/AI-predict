...
lr=0.0006         #学习率
#——————————————————导入数据——————————————————————
df=pd.read_excel('D:/AI/xianfengsg/forecaset/V1.5-STORE/LSTM-MULITI.xlsx',encoding='utf_8_sig')
...
def lstm(X):
    ...
    output_rnn,final_states=keras.layers.RNN(cell, input_rnn,initial_state=init_state, dtype=tf.float32)  #output_rnn是记录lstm每个输出节点的结果，final_states是最后一个cell的结果
