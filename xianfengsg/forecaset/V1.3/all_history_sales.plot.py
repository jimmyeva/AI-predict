...
def plot_compare(data,DC,id,sku_name,dc_name):
    ...
    if data.empty==True:            #-------------------确保程序运行，有可能有的DC没有SKU的预测信息
        ...
        plt.savefig("D:/jimmy-ye/AI_supply_chain/data/forecast_holiday/weather_forecast/all_history_compare" +
    ...
    for DC in tqdm(DC_list):
        ...
        for x in tqdm(sku_id_list):
            ...
            if real_sales.empty == True:
                ...
                merge_data.to_csv\
                    ('D:/jimmy-ye/AI_supply_chain/data/forecast_holiday/weather_forecast/all_history_compare'
                     +str(int(DC)) + str(dc_name) +
...
main_function('D:/jimmy-ye/AI_supply_chain/data/forecast_holiday/final_holiday_weather.csv',start)