...
class sales_cleaning():
    ...
    def data_cleaning(self,df_sales):
        ...
        print('forbid_index',len(forbid_index),forbid_index)
        ...
        # new_start = noise_data['Account_date'].min()
        # fill_date = pd.DataFrame({'Account_date': pd.date_range(new_start, end_date, freq='D')})
        # sales = pd.merge(fill_date, df_sales, how='left', on='Account_date').fillna(0)
        # return sales
