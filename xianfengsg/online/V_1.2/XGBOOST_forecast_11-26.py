...
def predict_with_XGBoosting(data,test_data):
    ...
    print(type(predict_feature[0].iloc[0]))
...
def get_his_sales(df,start_date,end_date):
    ...
    # i = '3009441'
        ...
        if stkout_detail.empty == True:
            ...
            # stkout_detail.to_csv('D:/AI/xianfengsg/online/V_1.2/data/stkout_detail' + str(i) + '.csv', encoding='utf_8_sig')
            result_mid = data_group(stkout_detail)
            print('result_mid',result_mid)
            # result_mid.to_csv('D:/AI/xianfengsg/online/V_1.2/data/result_mid'+str(i)+'.csv',encoding='utf_8_sig')
...
def main():
    ...
    # result_forecast.to_csv('D:/AI/xianfengsg/online/V_1.2/result_forecast-12-04.csv',encoding='utf_8_sig')
    # db = connectdb()
    # drop_data(db)
