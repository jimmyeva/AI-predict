...
def test_sku(data):
    ssd = pd.DataFrame({'GOODS_CODE':['65550','07540','06290','01310','05020','06850','07600','07300','01020','12240']})
...
def algorithm_SS(final, tomorrow_date, TDAT_date):
    ...
    for i in Code:
        ...
        std = np.sqrt(((forecast - np.mean(forecast)) ** 2).sum() / (forecast.size)) #(forecast.size + 1)
...
def main():
    ...
    print(AI_suggestion)
    AI_suggestion.to_csv('D:/AI/xianfengsg/online/V_1.2/AI_suggestion-11-26.csv',encoding='utf_8_sig')
