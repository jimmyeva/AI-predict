    ...
    for days in pd.date_range(A,B):
        ...
        if days == A:
          ...
          ## parameters for predict time
            ...
            quota_time = order_date.strftime('%Y%m%d')
            ...
            for i in range(len(parameter_condition)):
                ...
                custom_business_num, quota_time)
                ...
                if manufacturer_num == '000320':
                    ...
                    Final_Ordering.to_csv('D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/'
                                          'v1---仿真/02_仿真输出/evaluation-17/piece_bar_code/' +str(t2)+ str(
                        days) +'.csv', encoding="utf_8_sig")
            ...
            if mid_get_replenishment.empty == True:
                ...
                basic_sheet_merge_Temporary = final_sheet.append(basic_sheet)
                basic_sheet_merge_Temporary = basic_sheet_merge_Temporary.fillna(0)
            basic_sheet_merge_Temporary.to_csv('D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/v1---仿真/02_仿真输出/evaluation-17/basic_sheet_merge_Temporary' + str(
                days) + '.csv', encoding="utf_8_sig")
            ...
            basic_sheet_merge_01_today.to_csv(
                'D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/v1---仿真/02_仿真输出/evaluation-17/basic_sheet_merge_01_today' + str(
                    days) + '.csv', encoding="utf_8_sig")
            ...
            for i in range(len(parameter_condition)):
                ...
                if manufacturer_num == '000320':
                    ...
                    for barcode in Unique_Barcode:
                        ...
                        Final_Ordering = pd.concat([Final_Ordering, Order_frame_End])
                    Final_Ordering.to_csv('D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/'
                                          'v1---仿真/02_仿真输出/evaluation-17/piece_bar_code/'+str(t2)+ str(days)+
            ...
            basic_today.to_csv(
                'D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/v1---仿真/02_仿真输出/evaluation-17/basic_today' + str(days) + '.csv',
                encoding="utf_8_sig")
            final_sheet = final_sheet.append(basic_today)
        #此部操作是将每次补货的结果都进行集中到replenishment_AI_totaldataframe中
        final_sheet.to_csv('D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/v1---仿真/02_仿真输出/evaluation-17/final_sheet'+str(days)+'.csv', encoding="utf_8_sig")
        replenishment_AI_total= replenishment_AI_total.append(replenishment_AI)
        replenishment_AI_total.to_csv('D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/v1---仿真/02_仿真输出/evaluation-17/replenishment_AI_total' + str(days) + '.csv',
                           encoding="utf_8_sig")
    replenishment_AI_total.to_csv('D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/v1---仿真/02_仿真输出/evaluation-17/replenishment_AI_total.csv', encoding="utf_8_sig")
    final_sheet.to_csv('D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/v1---仿真/02_仿真输出/evaluation-17/final_sheet_revised.csv', encoding="utf_8_sig")
    calculate_finance = Calculate_finance(final_sheet,parameter)
    calculate_finance.to_csv('D:/project/P&G/数据及文档/01_相关解释文档/02_补货策略文档/v1---补货/v1---仿真/02_仿真输出/evaluation-17/calculate_finance_revised.csv',encoding="utf_8_sig")
start_end_date('20190210','20190315',0)
